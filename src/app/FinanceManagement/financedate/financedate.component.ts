...
@Component({
  selector: 'app-financedate',
  templateUrl: './financedate.component.html',
  styleUrls: ['./financedate.component.scss']
})
export class FinancedateComponent implements OnInit {
  ...
  addapi1(){
    this.router.navigate(['main/Financesinglebill'])
  }
