...
@Component({
  selector: 'app-financesinglebill',
  templateUrl: './financesinglebill.component.html',
  styleUrls: ['./financesinglebill.component.scss']
})
export class FinancesinglebillComponent implements OnInit {
  ...
  addapi1(){
    this.router.navigate(['main/Financeinvoiceview'])
  }


  addapi2(){
    this.router.navigate(['main/Financeupdateinvoice'])
  }
  ...
  // }
  addapi5(){
    this.router.navigate(['main/Financecreateinvoice'])
  }
}
