...
@Component({
  selector: 'app-salarydate',
  templateUrl: './salarydate.component.html',
  styleUrls: ['./salarydate.component.scss']
})
export class SalarydateComponent implements OnInit {
  ...
  addapi1(){
    this.router.navigate(['main/Finanacesalelist'])
  }
