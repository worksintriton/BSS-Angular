...
@Component({
  selector: 'app-salarymonthly',
  templateUrl: './salarymonthly.component.html',
  styleUrls: ['./salarymonthly.component.scss']
})
export class SalarymonthlyComponent implements OnInit {
  ...
  addapi1(){
    this.router.navigate(['main/Finanacesaledate'])
  }
