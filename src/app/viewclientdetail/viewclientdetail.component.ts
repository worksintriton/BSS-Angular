...
@Component({
  selector: 'app-viewclientdetail',
  templateUrl: './viewclientdetail.component.html',
  styleUrls: ['./viewclientdetail.component.scss']
})
export class ViewclientdetailComponent implements OnInit {
  ...
  constructor( private httpClient:HttpClient, private route: ActivatedRoute, private router: Router ) {
    ...
    this.route.params.subscribe(params => {
     ...
     this.httpClient.post('http://localhost/authentication/clientid',{cliid:this.cliid}).subscribe((data:any)  => {
