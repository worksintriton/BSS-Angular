...
@Component({
  selector: 'app-addemployeepg1',
  templateUrl: './addemployeepg1.component.html',
  styleUrls: ['./addemployeepg1.component.scss']
})
export class Addemployeepg1Component implements OnInit {
