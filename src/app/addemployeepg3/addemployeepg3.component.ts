...
@Component({
  selector: 'app-addemployeepg3',
  templateUrl: './addemployeepg3.component.html',
  styleUrls: ['./addemployeepg3.component.scss']
})
export class Addemployeepg3Component implements OnInit {
  datas: any;  
  email_id:any;
  adduser: Adduser;
  ...
  ngOnInit() {
     ...
     addapi(){
      ...
      if(this.datas.data.message == "Employee Details add Successfully"){
        this.router.navigate(['main/addemployee2/' + this.email_id])
