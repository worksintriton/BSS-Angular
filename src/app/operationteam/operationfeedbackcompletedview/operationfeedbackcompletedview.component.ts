...
@Component({
  selector: 'app-operationfeedbackcompletedview',
  templateUrl: './operationfeedbackcompletedview.component.html',
  styleUrls: ['./operationfeedbackcompletedview.component.scss']
})
export class OperationfeedbackcompletedviewComponent implements OnInit {
  ...
  public view(event, item) {
    ...
    this.router.navigate(['main/operacomcompleteview'])
  }
