...
@Component({
  selector: 'app-operationfeedbackinprogress',
  templateUrl: './operationfeedbackinprogress.component.html',
  styleUrls: ['./operationfeedbackinprogress.component.scss']
})
export class OperationfeedbackinprogressComponent implements OnInit {
